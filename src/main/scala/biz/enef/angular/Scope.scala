...
trait Scope extends js.Object {
   ...
   */
  def $watch(watchExpression: js.Any, listener: js.Function = null) : js.Function = ???
   ...
   * @return de-registration function
   */
  def $watchGroup(watchExpressions: js.Array[js.Object], listener: js.Function) : js.Function = ???
