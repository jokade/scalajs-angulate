...
trait Scope extends js.Object {
   ...
   */
  def $apply(exp: js.Object = ???) : js.Any = ???
   ...
   * @param exp An angular expression to be executed (string or a `function(scope)`)
   */
  def $applyAsync(exp: js.Object = ???) : js.Any = ???
   ...
   */
  def $eval(expression: js.Object = ???, locals: js.Object = ???) : js.Any = ???
   ...
   * @param locals Local variables object, useful for overriding values in scope
   */
  def $evalAsync(expression: js.Object = ???, locals: js.Object = ???) : js.Any = ???
   ...
   */
  def $on(name: String, listener: js.Function) : js.Function = ???
   ...
   */
  def $watch(watchExpression: String, listener: js.Function3[js.Any,js.Any,Scope,Unit]) : js.Function = ???
   ...
   * @return de-registration function
   */
  def $watch(watchExpression: js.Function, listener: js.Function3[js.Any,js.Any,Scope,Unit]) : js.Function = ???
   ...
   * @return de-registration function
   */
  def $watchGroup(watchExpressions: js.Array[js.Object], listener: js.Function3[js.Array[js.Any],js.Array[js.Any],Scope,Unit]) : js.Function = ???
   ...
   * @return De-registration function
   */
  def $watchCollection(obj: js.Object, listener: js.Function3[js.Object,js.Object,Scope,Unit]) : js.Function = ???
